...
console.log('The total number of button element is', document.querySelectorAll('button').length);

// 18. Select all the `label` element and log the count.
console.log('The total number of label elements are', document.querySelectorAll('label').length);
...
document.querySelector('.topics').previousElementSibling.innerText = 'Learning About Walking the DOM';

// 24. Select the first element child of the element stored in `topics` variable (#5) and change the `innerText` property of the element to `This is the first child element`.
document.querySelector('.topics').firstElementChild.innerText = 'This is the first child element';
